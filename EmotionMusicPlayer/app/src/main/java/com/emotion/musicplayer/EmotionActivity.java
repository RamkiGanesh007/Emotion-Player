...
public class EmotionActivity extends AppCompatActivity {
                                ...
                                new OnSuccessListener<List<FirebaseVisionFace>>() {
                                    ...
                                    public void onSuccess(List<FirebaseVisionFace> faces) {
                                        ...
                                        if (!faces.isEmpty()) {
                                            ...
                                            txtemotion.setText("No Face Is Detected , Please Try Again");
    ...
    private void classifyEmotions(Bitmap imageBitmap, int faceId) {
        ...
        ArrayList<String> emotions=new ArrayList<>(Arrays.asList("Angry","Happy","Sad","Neutral"));

        for(String i:reversedKeys)
        {
